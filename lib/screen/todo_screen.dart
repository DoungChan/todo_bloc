...
class TodoScreen extends StatelessWidget {
  ...
  Widget _todo(Model todo, context) {
    return InkWell(
      onTap: () => Navigator.pushNamed(context, EDIT_TODO, arguments: todo),
      child: Dismissible(
        key: Key("${todo.id}"),
  ...
  Widget _todoTile(Model todo, context) {
    return Container(
  ...
  Widget _completionIndicator(Model todo) {
    return Container(
      width: 20.0,
      height: 20.0,
      decoration: BoxDecoration(
